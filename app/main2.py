...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder.appName("DataAnalysisApp").master("spark://spark-master:7077").getOrCreate()
    #spark = SparkSession.builder.appName("DataAnalysisApp").master("local[2]").getOrCreate()

    # Putanja do podataka
    data_path = "hdfs://namenode:9000/hddata/sumoTrace.csv"
    ...
    data_path = "hdfs://namenode:9000/hddata/my_emission_file.csv"
    ...
    # Produzavanje trajanja Spark sesije radi dodatnih analiza
    #time.sleep(180)
